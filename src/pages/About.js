      ...
      <div className="relative px-8 md:flex-row md:px-32">
        <div className="grid grid-cols-6 col mt-5 px-32 gap-5">
          <div className="col-span-4">
            ...
            <p className="mt-5">
              Currently, I am working for a company called Webisoft as a
              Software Developer for over a year. Here, so far I have delivered
              3 solo projects where I was responsible for front-end development
              and communicating requirements with clients, designers and backend
              ...
              previous role, I worked on a SaaS platform, building, and
              delivering features like interactive dashboards for varied users
              while working in an agile environment. I worked in Angular during
              2.5 years of my tenure.
            </p>
          </div>
